...
@DisplayName("Text Questionnaire Question")
class TextQuestionnaireQuestionTest {

    private TextQuestionnaireQuestion sut;
    ...
    void setup(){
        ...
        sut = (TextQuestionnaireQuestion) new QuestionnaireQuestionBuilder()
                .setType(type)
                .setId(id)
                .setName(name)
                .setClasses(classes)
    ...
    class MergeTest {
        ...
        void test(){
            ...
            assertTrue(result instanceof TextQuestionnaireQuestion);

            final TextQuestionnaireQuestion resultAsImpl = (TextQuestionnaireQuestion) result;
