...
@DisplayName("Number Questionnaire Question")
class NumberQuestionnaireQuestionTest {

    private NumberQuestionnaireQuestion sut;
    ...
    @BeforeEach
    void setup(){
        type = QuestionnaireQuestionType.NUMBER;
        ...
        sut = (NumberQuestionnaireQuestion) new QuestionnaireQuestionBuilder()
                .setType(type)
                .setId(id)
                .setName(name)
                .setClasses(classes)
    ...
    class MergeTest {
        ...
        void test(){
            ...
            assertTrue(result instanceof NumberQuestionnaireQuestion);

            final NumberQuestionnaireQuestion resultAsImpl = (NumberQuestionnaireQuestion) result;
