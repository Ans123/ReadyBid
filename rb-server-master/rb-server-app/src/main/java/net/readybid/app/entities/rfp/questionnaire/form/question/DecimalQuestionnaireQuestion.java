...
public class DecimalQuestionnaireQuestion implements QuestionnaireQuestion {

    final QuestionnaireQuestionImpl question;

    DecimalQuestionnaireQuestion(QuestionnaireQuestionImpl question) {
        this.question = question;
    }

    @Override
    public QuestionnaireQuestion merge(QuestionnaireQuestion model) {
        return model == null ? null : new DecimalQuestionnaireQuestion(question.merge(model));
    }
