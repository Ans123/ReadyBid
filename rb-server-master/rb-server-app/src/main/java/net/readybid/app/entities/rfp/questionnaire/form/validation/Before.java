...
public class Before implements QuestionnaireQuestionValidation {

    private final String field;
    private final boolean inclusive;

    public Before(String field, boolean inclusive) {
        this.field = field;
    ...
    public boolean isValid(String answer, Map<String, String> answers, Map<String, String> context) {
        ...
        try {
            ...
            return inclusive ? !answerDate.isAfter(compareTo) : answerDate.isBefore(compareTo);
    ...
    public Map.Entry<String, Object> toMapEntry() {
        return new AbstractMap.SimpleEntry<>("before", Arrays.asList(field, inclusive));
    }
}
