...
public class NumberQuestionnaireQuestion implements QuestionnaireQuestion {

    final QuestionnaireQuestionImpl question;

    NumberQuestionnaireQuestion(QuestionnaireQuestionImpl question) {
        this.question = question;
    }

    @Override
    public QuestionnaireQuestion merge(QuestionnaireQuestion model) {
        return model == null ? null : new NumberQuestionnaireQuestion(question.merge(model));
    }
