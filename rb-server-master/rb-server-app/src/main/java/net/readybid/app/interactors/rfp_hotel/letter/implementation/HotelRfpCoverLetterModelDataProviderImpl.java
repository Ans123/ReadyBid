...
class HotelRfpCoverLetterModelDataProviderImpl implements HotelRfpCoverLetterModelDataProvider {
    ...
    HotelRfpCoverLetterModelDataProviderImpl(Rfp rfp){
        buyer = rfp.getBuyer();
    ...
    HotelRfpCoverLetterModelDataProviderImpl(HotelRfpBid bid){
        buyer = bid.getBuyer();
        buyerCompany = buyer == null ? null : buyer.getCompany();
        buyerCompanyAddress = buyerCompany == null ? null : buyerCompany.getAddress();
        buyerContact = buyer == null ? null : buyer.getContact();
        ...
        destination = bid.getSubject();
        destinationAddress = destination == null ? null : destination.getAddress();
    }
    ...
    public String getPropertyName() {
        return supplierCompany == null ? null : supplierCompany.getName();
    }

    @Override
    public String getPropertyAddress1() {
        return supplierCompanyAddress == null ? null : supplierCompanyAddress.getAddress1();
    }

    @Override
    public String getPropertyAddress2() {
        return supplierCompanyAddress == null ? null : supplierCompanyAddress.getAddress2();
    }

    @Override
    public String getPropertyCity() {
        return supplierCompanyAddress == null ? null : supplierCompanyAddress.getCity();
    }

    @Override
    public String getPropertyState() {
        return supplierCompanyAddress == null ? null : supplierCompanyAddress.getStateOrRegion();
    }

    @Override
    public String getPropertyZip() {
        return supplierCompanyAddress == null ? null : supplierCompanyAddress.getZip();
    }

    @Override
    public String getPropertyCountry() {
        return supplierCompanyAddress == null ? null : supplierCompanyAddress.getCountryName();
    }

    @Override
    public String getPropertyFullAddress() {
        return supplierCompany == null ? null : supplierCompany.getFullAddress();
    }

    @Override
    public String getPropertyShortAddress() {
        return supplierCompanyAddress == null ? null : supplierCompanyAddress.getShortAddress();
    }

    @Override
    public String getPropertyPhone() {
        return supplierCompany == null ? null : supplierCompany.getPhone();
    }

    @Override
    public String getPropertyWebsite() {
        return supplierCompany == null ? null : supplierCompany.getWebsite();
    }

    @Override
    public String getPropertyEmailAddress() {
        return supplierCompany == null ? null : supplierCompany.getEmailAddress();
    }

    @Override
    public String getPropertyMasterChain() {
        return supplierCompany == null ? null : supplierCompany.getMasterChainName();
    }

    @Override
    public String getPropertyBrand() {
        return supplierCompany == null ? null : supplierCompany.getBrandChainName();
    }
    ...
    @Override
    public String getTravelDestinationEstimatedSpend() {
        return destination == null ? null : String.valueOf(destination.getEstimatedSpend());
    }

    @Override
    public String getTravelDestinationEstimatedRoomNights() {
        return destination == null ? null : String.valueOf(destination.getEstimatedRoomNights());
    }

    @Override
    public String getTravelDestinationAddress1() {
        return destinationAddress == null ? null : destinationAddress.getAddress1();
    }

    @Override
    public String getTravelDestinationAddress2() {
        return destinationAddress == null ? null : destinationAddress.getAddress2();
    }

    @Override
    public String getTravelDestinationCity() {
        return destinationAddress == null ? null : destinationAddress.getCity();
    }

    @Override
    public String getTravelDestinationState() {
        return destinationAddress == null ? null : destinationAddress.getStateOrRegion();
    }

    @Override
    public String getTravelDestinationZip() {
        return destinationAddress == null ? null : destinationAddress.getZip();
    }

    @Override
    public String getTravelDestinationCountry() {
        return destinationAddress == null ? null : destinationAddress.getCountryName();
    }

    @Override
    public String getTravelDestinationFullAddress() {
        return destination == null ? null : destinationAddress.getFullAddress();
    }

    @Override
    public String getTravelDestinationShortAddress() {
        return destinationAddress == null ? null : destinationAddress.getShortAddress();
    }
}
